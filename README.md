...
A fully customizable, mobile-responsive UI for CE.SDK built with React. This starterkit demonstrates how to build a complete custom editor interface from scratch with touch-optimized controls and mobile-first design patterns.
...
│   │   │   ├── MobileUI/      # Main mobile UI wrapper
│   │   │   ├── TopBar/        # Top navigation bar
│   │   │   ├── BottomControls/# Context-sensitive controls
│   │   │   ├── CESDKCanvas/   # Canvas wrapper
│   │   │   └── ...           # Many specialized components
│   │   ├── contexts/          # React contexts
│   │   │   └── EditorContext.tsx  # Engine state management
│   │   ├── hooks/             # Custom React hooks
│   │   │   ├── UseSelection.tsx   # Selection tracking
│   │   │   ├── UseSinglePageFocus.ts  # Viewport management
│   │   │   └── UseSelectedProperty.ts # Property editing
│   │   └── icons/             # SVG icon components
│   └── imgly/                 # CE.SDK integration layer
│       ├── ColorUtilities.ts  # Color conversion helpers
│       ├── CreativeEngineUtils.ts  # Engine utilities
│       ├── upload.ts          # File upload helpers
│       └── utils.ts           # General utilities
├── public/                    # Static assets
│   ├── social-media.scene     # Default scene file
│   └── font-previews/         # Font preview images
